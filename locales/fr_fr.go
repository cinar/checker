...
var FrFRMessages = map[string]string{
	...
	"NOT_LTE":             "La valeur ne peut pas être supérieure à {{ .n }}.",
	...
	"NOT_BASE64":          "N'est pas une chaîne encodée en base64 valide.",
	"NOT_BASE64_URL":      "N'est pas une chaîne encodée en base64url valide.",
	"NOT_E164":            "N'est pas un numéro de téléphone E.164 valide.",
	"NOT_HEX_COLOR":       "N'est pas un code couleur hexadécimal valide.",
	"NOT_IBAN":            "N'est pas un IBAN valide.",
	"NOT_JWT":             "N'est pas un JWT valide.",
	"NOT_MONGO_ID":        "N'est pas un ObjectID MongoDB valide.",
	"NOT_SEMVER":          "N'est pas une version sémantique valide.",
	"NOT_SLUG":            "N'est pas un slug valide.",
	"NOT_ULID":            "N'est pas un ULID valide.",
}
