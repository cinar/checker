...
var TrTRMessages = map[string]string{
	...
	"NOT_FINITE":          "Değer sonlu bir sayı olmalı.",
	...
	"NOT_INT":             "Değer bir tam sayı olmalı.",
	...
	"NOT_MULTIPLE_OF":     "Değer {{ .n }} değerinin katı olmalı.",
	"NOT_NEGATIVE":        "Değer negatif olmalı.",
	"NOT_NONNEGATIVE":     "Değer negatif olamaz.",
	...
	"NOT_BASE64":          "Geçerli bir base64 ile kodlanmış dize değil.",
	"NOT_BASE64_URL":      "Geçerli bir base64url ile kodlanmış dize değil.",
	"NOT_E164":            "Geçerli bir E.164 telefon numarası değil.",
	"NOT_HEX_COLOR":       "Geçerli bir onaltılık renk kodu değil.",
	"NOT_IBAN":            "Geçerli bir IBAN değil.",
	"NOT_JWT":             "Geçerli bir JWT değil.",
	"NOT_MONGO_ID":        "Geçerli bir MongoDB ObjectID değil.",
	"NOT_SEMVER":          "Geçerli bir anlamsal sürüm değil.",
	"NOT_SLUG":            "Geçerli bir slug değil.",
	"NOT_ULID":            "Geçerli bir ULID değil.",
}
