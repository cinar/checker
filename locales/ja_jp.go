...
var JaJPMessages = map[string]string{
	...
	"NOT_LTE":             "値は{{ .n }}を超えることはできません。",
	"NOT_LUHN":            "有効なLUHN番号ではありません。",
	"NOT_MAC":             "有効なMACアドレスではありません。",
	"NOT_MAX_LEN":         "値は{{ .max }}を超えることはできません。",
	"NOT_MIN_LEN":         "値は{{ .min }}未満にはできません。",
	"NOT_MULTIPLE_OF":     "値は{{ .n }}の倍数である必要があります。",
	"NOT_NEGATIVE":        "値は負の数である必要があります。",
	"NOT_NONNEGATIVE":     "値は負の数にはできません。",
	...
	"NOT_BASE64":          "有効なbase64エンコード文字列ではありません。",
	"NOT_BASE64_URL":      "有効なbase64urlエンコード文字列ではありません。",
	"NOT_E164":            "有効なE.164形式の電話番号ではありません。",
	"NOT_HEX_COLOR":       "有効な16進数カラーコードではありません。",
	"NOT_IBAN":            "有効なIBANではありません。",
	"NOT_JWT":             "有効なJWTではありません。",
	"NOT_MONGO_ID":        "有効なMongoDBのObjectIDではありません。",
	"NOT_SEMVER":          "有効なセマンティックバージョンではありません。",
	"NOT_SLUG":            "有効なスラッグではありません。",
	"NOT_ULID":            "有効なULIDではありません。",
}
