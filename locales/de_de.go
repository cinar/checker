...
var DeDEMessages = map[string]string{
	...
	"NOT_FINITE":          "Der Wert muss eine endliche Zahl sein.",
	...
	"NOT_INT":             "Der Wert muss eine ganze Zahl sein.",
	...
	"NOT_MULTIPLE_OF":     "Der Wert muss ein Vielfaches von {{ .n }} sein.",
	"NOT_NEGATIVE":        "Der Wert muss negativ sein.",
	"NOT_NONNEGATIVE":     "Der Wert darf nicht negativ sein.",
	...
	"NOT_BASE64":          "Keine gültige base64-kodierte Zeichenfolge.",
	"NOT_BASE64_URL":      "Keine gültige base64url-kodierte Zeichenfolge.",
	"NOT_E164":            "Keine gültige Telefonnummer im E.164-Format.",
	"NOT_HEX_COLOR":       "Kein gültiger Hex-Farbcode.",
	"NOT_IBAN":            "Keine gültige IBAN.",
	"NOT_JWT":             "Kein gültiges JWT.",
	"NOT_MONGO_ID":        "Keine gültige MongoDB-ObjectID.",
	"NOT_SEMVER":          "Keine gültige semantische Version.",
	"NOT_SLUG":            "Kein gültiger Slug.",
	"NOT_ULID":            "Keine gültige ULID.",
}
