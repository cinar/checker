...
var EnUSMessages = map[string]string{
	...
	"NOT_INT":             "Value must be a whole number.",
	...
	"NOT_LTE":             "Value cannot be greater than {{ .n }}.",
	...
	"NOT_MULTIPLE_OF":     "Value must be a multiple of {{ .n }}.",
	"NOT_NEGATIVE":        "Value must be negative.",
	"NOT_NONNEGATIVE":     "Value cannot be negative.",
	...
	"NOT_BASE64":          "Not a valid base64-encoded string.",
	"NOT_BASE64_URL":      "Not a valid base64url-encoded string.",
	"NOT_E164":            "Not a valid E.164 phone number.",
	"NOT_HEX_COLOR":       "Not a valid hex color code.",
	"NOT_IBAN":            "Not a valid IBAN.",
	"NOT_JWT":             "Not a valid JWT.",
	"NOT_MONGO_ID":        "Not a valid MongoDB ObjectID.",
	"NOT_SEMVER":          "Not a valid semantic version.",
	"NOT_SLUG":            "Not a valid slug.",
	"NOT_ULID":            "Not a valid ULID.",
}
