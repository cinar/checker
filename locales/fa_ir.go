...
var FaIRMessages = map[string]string{
	...
	"NOT_FINITE":          "مقدار باید یک عدد متناهی باشد.",
	...
	"NOT_INT":             "مقدار باید یک عدد صحیح باشد.",
	...
	"NOT_LTE":             "مقدار نمی\u200cتواند بیشتر از {{ .n }} باشد.",
	...
	"NOT_BASE64":          "یک رشتهٔ کدگذاری\u200cشده با base64 معتبر نیست.",
	"NOT_BASE64_URL":      "یک رشتهٔ کدگذاری\u200cشده با base64url معتبر نیست.",
	"NOT_E164":            "شمارهٔ تلفن معتبر با قالب E.164 نیست.",
	"NOT_HEX_COLOR":       "کد رنگ هگزادسیمال معتبر نیست.",
	"NOT_IBAN":            "IBAN معتبر نیست.",
	"NOT_JWT":             "JWT معتبر نیست.",
	"NOT_MONGO_ID":        "ObjectID معتبر MongoDB نیست.",
	"NOT_SEMVER":          "نسخهٔ معنایی معتبر نیست.",
	"NOT_SLUG":            "slug معتبر نیست.",
	"NOT_ULID":            "ULID معتبر نیست.",
}
