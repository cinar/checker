...
var PtBRMessages = map[string]string{
	...
	"NOT_CONTAINS":        "O valor deve conter {{ .substr }}.",
	...
	"NOT_ENDS_WITH":       "O valor deve terminar com {{ .suffix }}.",
	...
	"NOT_GT":              "O valor deve ser maior que {{ .n }}.",
	...
	"NOT_LT":              "O valor deve ser menor que {{ .n }}.",
