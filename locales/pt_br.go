...
var PtBRMessages = map[string]string{
	...
	"NOT_INT":             "O valor deve ser um número inteiro.",
	...
	"NOT_LTE":             "O valor não pode ser maior que {{ .n }}.",
	...
	"NOT_MULTIPLE_OF":     "O valor deve ser um múltiplo de {{ .n }}.",
	"NOT_NEGATIVE":        "O valor deve ser negativo.",
	"NOT_NONNEGATIVE":     "O valor não pode ser negativo.",
	...
	"NOT_BASE64":          "Não é uma string codificada em base64 válida.",
	"NOT_BASE64_URL":      "Não é uma string codificada em base64url válida.",
	"NOT_E164":            "Não é um número de telefone E.164 válido.",
	"NOT_HEX_COLOR":       "Não é um código de cor hexadecimal válido.",
	"NOT_IBAN":            "Não é um IBAN válido.",
	"NOT_JWT":             "Não é um JWT válido.",
	"NOT_MONGO_ID":        "Não é um ObjectID do MongoDB válido.",
	"NOT_SEMVER":          "Não é uma versão semântica válida.",
	"NOT_SLUG":            "Não é um slug válido.",
	"NOT_ULID":            "Não é um ULID válido.",
}
