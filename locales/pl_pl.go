...
var PlPLMessages = map[string]string{
	...
	"NOT_FINITE":          "Wartość musi być liczbą skończoną.",
	...
	"NOT_INT":             "Wartość musi być liczbą całkowitą.",
	...
	"NOT_MULTIPLE_OF":     "Wartość musi być wielokrotnością {{ .n }}.",
	"NOT_NEGATIVE":        "Wartość musi być ujemna.",
	"NOT_NONNEGATIVE":     "Wartość nie może być ujemna.",
	...
	"NOT_BASE64":          "Nieprawidłowy ciąg zakodowany w base64.",
	"NOT_BASE64_URL":      "Nieprawidłowy ciąg zakodowany w base64url.",
	"NOT_E164":            "Nieprawidłowy numer telefonu w formacie E.164.",
	"NOT_HEX_COLOR":       "Nieprawidłowy szesnastkowy kod koloru.",
	"NOT_IBAN":            "Nieprawidłowy IBAN.",
	"NOT_JWT":             "Nieprawidłowy JWT.",
	"NOT_MONGO_ID":        "Nieprawidłowy identyfikator MongoDB ObjectID.",
	"NOT_SEMVER":          "Nieprawidłowa wersja semantyczna.",
	"NOT_SLUG":            "Nieprawidłowy slug.",
	"NOT_ULID":            "Nieprawidłowy ULID.",
}
