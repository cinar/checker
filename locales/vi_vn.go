...
var ViVNMessages = map[string]string{
	...
	"NOT_FINITE":          "Giá trị phải là số hữu hạn.",
	...
	"NOT_INT":             "Giá trị phải là số nguyên.",
	...
	"NOT_MULTIPLE_OF":     "Giá trị phải là bội số của {{ .n }}.",
	"NOT_NEGATIVE":        "Giá trị phải là số âm.",
	"NOT_NONNEGATIVE":     "Giá trị không được là số âm.",
	...
	"NOT_BASE64":          "Không phải là chuỗi được mã hóa base64 hợp lệ.",
	"NOT_BASE64_URL":      "Không phải là chuỗi được mã hóa base64url hợp lệ.",
	"NOT_E164":            "Không phải là số điện thoại E.164 hợp lệ.",
	"NOT_HEX_COLOR":       "Không phải là mã màu thập lục phân hợp lệ.",
	"NOT_IBAN":            "Không phải là IBAN hợp lệ.",
	"NOT_JWT":             "Không phải là JWT hợp lệ.",
	"NOT_MONGO_ID":        "Không phải là ObjectID MongoDB hợp lệ.",
	"NOT_SEMVER":          "Không phải là phiên bản ngữ nghĩa hợp lệ.",
	"NOT_SLUG":            "Không phải là slug hợp lệ.",
	"NOT_ULID":            "Không phải là ULID hợp lệ.",
}
