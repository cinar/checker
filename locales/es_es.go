...
var EsESMessages = map[string]string{
	...
	"NOT_INT":             "El valor debe ser un número entero.",
	...
	"NOT_MULTIPLE_OF":     "El valor debe ser un múltiplo de {{ .n }}.",
	"NOT_NEGATIVE":        "El valor debe ser negativo.",
	"NOT_NONNEGATIVE":     "El valor no puede ser negativo.",
	...
	"NOT_BASE64":          "No es una cadena codificada en base64 válida.",
	"NOT_BASE64_URL":      "No es una cadena codificada en base64url válida.",
	"NOT_E164":            "No es un número de teléfono E.164 válido.",
	"NOT_HEX_COLOR":       "No es un código de color hexadecimal válido.",
	"NOT_IBAN":            "No es un IBAN válido.",
	"NOT_JWT":             "No es un JWT válido.",
	"NOT_MONGO_ID":        "No es un ObjectID de MongoDB válido.",
	"NOT_SEMVER":          "No es una versión semántica válida.",
	"NOT_SLUG":            "No es un slug válido.",
	"NOT_ULID":            "No es un ULID válido.",
}
