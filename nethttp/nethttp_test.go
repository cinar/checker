...
func newTestRequest(method, body string) (*http.Request, *httptest.ResponseRecorder) {
...
func TestBindSuccess(t *testing.T) {
	req, recorder := newTestRequest(http.MethodPost, `{"name":"  Onur Cinar  ","email":"onur@example.com"}`)

	var registration Registration

	if !checkernethttp.Bind(recorder, req, &registration) {
...
func TestBindInvalidJSON(t *testing.T) {
	req, recorder := newTestRequest(http.MethodPost, `{"name":`)
...
func TestBindValidationFailure(t *testing.T) {
	req, recorder := newTestRequest(http.MethodPost, `{"name":"","email":""}`)
...
func TestCheckSuccess(t *testing.T) {
	_, recorder := newTestRequest(http.MethodPost, "")
	...
	if !checkernethttp.Check(recorder, registration) {
